...
def mult_matriz_vetor(M, vetor):
    sol = Vetor(
        M[0][0]*(getattr(vetor,"x")) + M[0][1]*(getattr(vetor,"y")) +M[0][2]*(getattr(vetor,"z")),
        M[1][0]*(getattr(vetor,"x")) + M[1][1]*(getattr(vetor,"y")) +M[1][2]*(getattr(vetor,"z")),
        M[2][0]*(getattr(vetor,"x")) + M[2][1]*(getattr(vetor,"y")) +M[2][2]*(getattr(vetor,"z")),
    )
    return sol

def mult_matriz_ponto(M, vetor):
    sol = Ponto(
        M[0][0]*(getattr(vetor,"x")) + M[0][1]*(getattr(vetor,"y")) +M[0][2]*(getattr(vetor,"z")) + M[0][3],
        M[1][0]*(getattr(vetor,"x")) + M[1][1]*(getattr(vetor,"y")) +M[1][2]*(getattr(vetor,"z")) + M[1][3],
        M[2][0]*(getattr(vetor,"x")) + M[2][1]*(getattr(vetor,"y")) +M[2][2]*(getattr(vetor,"z")) + M[2][3],
    )
